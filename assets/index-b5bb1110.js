 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function e_(t){ti(new ur("platform-logger",e=>new mk(e),"PRIVATE")),ti(new ur("heartbeat",e=>new Yk(e),"PRIVATE")),Nn(Mc,Cp,t),Nn(Mc,Cp,"esm2017"),Nn("fire-js","")}e_("");var t_="firebase",n_="9.18.0";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const fr=new sd("@firebase/firestore");function am(){return fr.logLevel}function x(t,...e){if(fr.logLevel<=G.DEBUG){const n=e.map(Ud);fr.debug(`Firestore (${gi}): ${t}`,...n)}}function Zt(t,...e){if(fr.logLevel<=G.ERROR){const n=e.map(Ud);fr.error(`Firestore (${gi}): ${t}`,...n)}}function Yc(t,...e){if(fr.logLevel<=G.WARN){const n=e.map(Ud);fr.warn(`Firestore (${gi}): ${t}`,...n)}}function Ud(t){if(typeof t=="string")return t;try{return e=t,JSON.stringify(e)}catch{return t}/**
* @license
* Copyright 2020 Google LLC
*
* Licensed under the Apache License, Version 2.0 (the "License");
