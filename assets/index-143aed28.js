 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Wk="firebase-heartbeat-database",qk=1,vs="firebase-heartbeat-store";let Iu=null;function Zy(){return Iu||(Iu=dk(Wk,qk,{upgrade:(t,e)=>{switch(e){case 0:t.createObjectStore(vs)}}}).catch(t=>{throw Cn.create("idb-open",{originalErrorMessage:t.message})})),Iu}async function Gk(t){try{return(await Zy()).transaction(vs).objectStore(vs).get(e0(t))}catch(e){if(e instanceof rn)cr.warn(e.message);else{const n=Cn.create("idb-get",{originalErrorMessage:e==null?void 0:e.message});cr.warn(n.message)}}}async function Np(t,e){try{const r=(await Zy()).transaction(vs,"readwrite");return await r.objectStore(vs).put(e,e0(t)),r.done}catch(n){if(n instanceof rn)cr.warn(n.message);else{const r=Cn.create("idb-set",{originalErrorMessage:n==null?void 0:n.message});cr.warn(r.message)}}}function e0(t){return`${t.name}!${t.options.appId}`}/**
 * @license
 * Copyright 2021 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Op(t){const e=t.toLowerCase();if(e.includes("opera/")||e.includes("opr/")||e.includes("opios/"))return"Opera";if(c0(e))return"IEMobile";if(e.includes("msie")||e.includes("trident/"))return"IE";if(e.includes("edge/"))return"Edge";if(l0(e))return"Firefox";if(e.includes("silk/"))return"Silk";if(d0(e))return"Blackberry";if(f0(e))return"Webos";if(dd(e))return"Safari";if((e.includes("chrome/")||u0(e))&&!e.includes("edge/"))return"Chrome";if(h0(e))return"Android";{const n=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,r=t.match(n);if((r==null?void 0:r.length)===2)return r[1]}return"Other"}function l0(t=je()){return/firefox\//i.test(t)}function dd(t=je()){const e=t.toLowerCase();return e.includes("safari/")&&!e.includes("chrome/")&&!e.includes("crios/")&&!e.includes("android")}function u0(t=je()){return/crios\//i.test(t)}function c0(t=je()){return/iemobile/i.test(t)}function h0(t=je()){return/android/i.test(t)}function d0(t=je()){return/blackberry/i.test(t)}function f0(t=je()){return/webos/i.test(t)}function hl(t=je()){return/iphone|ipad|ipod/i.test(t)||/macintosh/i.test(t)&&/mobile/i.test(t)}function __(t=je()){var e;return hl(t)&&!!(!((e=window.navigator)===null||e===void 0)&&e.standalone)}function I_(){return VS()&&document.documentMode===10}function p0(t=je()){return hl(t)||h0(t)||f0(t)||d0(t)||/windows phone/i.test(t)||c0(t)}function T_(){try{return!!(window&&window!==window.top)}catch{return!1}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function lm(t){let e=0;for(const n in t)Object.prototype.hasOwnProperty.call(t,n)&&e++;return e}function wr(t,e){for(const n in t)Object.prototype.hasOwnProperty.call(t,n)&&e(n,t[n])}function Mv(t){for(const e in t)if(Object.prototype.hasOwnProperty.call(t,e))return!1;return!0}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class I2{constructor(e){this.oe=e}}function T2(t){const e=g2({parent:t.parent,structuredQuery:t.structuredQuery});return t.limitType==="LAST"?th(e,e.limit,"L"):e}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class F2{constructor(){this.ki=!1}initialize(e,n){this.$i=e,this.indexManager=n,this.ki=!0}getDocumentsMatchingQuery(e,n,r,i){return this.Mi(e,n).next(s=>s||this.Oi(e,n,i,r)).next(s=>s||this.Fi(e,n))}Mi(e,n){if(gm(n))return k.resolve(null);let r=en(n);return this.indexManager.getIndexType(e,r).next(i=>i===0?null:(n.limit!==null&&i===1&&(n=th(n,null,"F"),r=en(n)),this.indexManager.getDocumentsMatchingTarget(e,r).next(s=>{const o=H(...s);return this.$i.getDocuments(e,o).next(a=>this.indexManager.getMinOffset(e,r).next(l=>{const u=this.Bi(n,a);return this.Li(n,u,o,l.readTime)?this.Mi(e,th(n,null,"F")):this.qi(e,u,n,l)}))})))}Oi(e,n,r,i){return gm(n)||i.isEqual(F.min())?this.Fi(e,n):this.$i.getDocuments(e,r).next(s=>{const o=this.Bi(n,s);return this.Li(n,o,r,i)?this.Fi(e,n):(am()<=G.DEBUG&&x("QueryEngine","Re-using previous result from %s to execute query: %s",i.toString(),nh(n)),this.qi(e,o,n,vC(i,-1)))})}Bi(e,n){let r=new Ee(Wv(e));return n.forEach((i,s)=>{xl(e,s)&&(r=r.add(s))}),r}Li(e,n,r,i){if(e.limit===null)return!1;if(r.size!==n.size)return!0;const s=e.limitType==="F"?n.last():n.first();return!!s&&(s.hasPendingWrites||s.version.compareTo(i)>0)}Fi(e,n){return am()<=G.DEBUG&&x("QueryEngine","Using full collection scan to execute query:",nh(n)),this.$i.getDocumentsMatchingQuery(e,n,Pn.min())}qi(e,n,r,i){return this.$i.getDocumentsMatchingQuery(e,r,i).next(s=>(n.forEach(o=>{s=s.insert(o.key,o)}),s))}}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $l(t){return new l2(t,!0)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class rN{constructor(e,n,r,i,s){this.localStore=e,this.datastore=n,this.asyncQueue=r,this.remoteSyncer={},this._u=[],this.wu=new Map,this.mu=new Set,this.gu=[],this.yu=s,this.yu.Gr(o=>{r.enqueueAndForget(async()=>{Er(this)&&(x("RemoteStore","Restarting streams for network reachability change."),await async function(a){const l=V(a);l.mu.add(4),await lo(l),l.pu.set("Unknown"),l.mu.delete(4),await bl(l)}(this))})}),this.pu=new nN(r,i)}}async function bl(t){if(Er(t))for(const e of t.gu)await e(!0)}async function lo(t){for(const e of t.gu)await e(!1)}function w1(t,e){const n=V(t);n.wu.has(e.targetId)||(n.wu.set(e.targetId,e),Yd(n)?Xd(n):vi(n).Mo()&&Qd(n,e))}function E1(t,e){const n=V(t),r=vi(n);n.wu.delete(e),r.Mo()&&S1(n,e),n.wu.size===0&&(r.Mo()?r.Bo():Er(n)&&n.pu.set("Unknown"))}function Qd(t,e){t.Iu.Ot(e.targetId),vi(t).Jo(e)}function S1(t,e){t.Iu.Ot(e),vi(t).Yo(e)}function Xd(t){t.Iu=new i2({getRemoteKeysForTarget:e=>t.remoteSyncer.getRemoteKeysForTarget(e),ie:e=>t.wu.get(e)||null}),vi(t).start(),t.pu.au()}function Yd(t){return Er(t)&&!vi(t).$o()&&t.wu.size>0}function Er(t){return V(t).mu.size===0}function k1(t){t.Iu=void 0}async function iN(t){t.wu.forEach((e,n)=>{Qd(t,e)})}async function sN(t,e){k1(t),Yd(t)?(t.pu.fu(e),Xd(t)):t.pu.set("Unknown")}async function oN(t,e,n){if(t.pu.set("Online"),e instanceof l1&&e.state===2&&e.cause)try{await async function(r,i){const s=i.cause;for(const o of i.targetIds)r.wu.has(o)&&(await r.remoteSyncer.rejectListen(o,s),r.wu.delete(o),r.Iu.removeTarget(o))}(t,e)}catch(r){x("RemoteStore","Failed to remove targets %s: %s ",e.targetIds.join(","),r),await qa(t,r)}else if(e instanceof na?t.Iu.Qt(e):e instanceof a1?t.Iu.Zt(e):t.Iu.Wt(e),!n.isEqual(F.min()))try{const r=await g1(t.localStore);n.compareTo(r)>=0&&await function(i,s){const o=i.Iu.ee(s);return o.targetChanges.forEach((a,l)=>{if(a.resumeToken.approximateByteSize()>0){const u=i.wu.get(l);u&&i.wu.set(l,u.withResumeToken(a.resumeToken,s))}}),o.targetMismatches.forEach(a=>{const l=i.wu.get(a);if(!l)return;i.wu.set(a,l.withResumeToken(Ke.EMPTY_BYTE_STRING,l.snapshotVersion)),S1(i,a);const u=new rr(l.target,a,1,l.sequenceNumber);Qd(i,u)}),i.remoteSyncer.applyRemoteEvent(o)}(t,n)}catch(r){x("RemoteStore","Failed to raise snapshot:",r),await qa(t,r)}}async function qa(t,e,n){if(!so(e))throw e;t.mu.add(1),await lo(t),t.pu.set("Offline"),n||(n=()=>g1(t.localStore)),t.asyncQueue.enqueueRetryable(async()=>{x("RemoteStore","Retrying IndexedDB access"),await n(),t.mu.delete(1),await bl(t)})}function _1(t,e){return e().catch(n=>qa(t,n,e))}async function Ul(t){const e=V(t),n=Ln(e);let r=e._u.length>0?e._u[e._u.length-1].batchId:-1;for(;aN(e);)try{const i=await K2(e.localStore,r);if(i===null){e._u.length===0&&n.Bo();break}r=i.batchId,lN(e,i)}catch(i){await qa(e,i)}I1(e)&&T1(e)}function aN(t){return Er(t)&&t._u.length<10}function lN(t,e){t._u.push(e);const n=Ln(t);n.Mo()&&n.Xo&&n.tu(e.mutations)}function I1(t){return Er(t)&&!Ln(t).$o()&&t._u.length>0}function T1(t){Ln(t).start()}async function uN(t){Ln(t).su()}async function cN(t){const e=Ln(t);for(const n of t._u)e.tu(n.mutations)}async function hN(t,e,n){const r=t._u.shift(),i=Kd.from(r,e,n);await _1(t,()=>t.remoteSyncer.applySuccessfulWrite(i)),await Ul(t)}async function dN(t,e){e&&Ln(t).Xo&&await async function(n,r){if(i=r.code,ZC(i)&&i!==_.ABORTED){const s=n._u.shift();Ln(n).Fo(),await _1(n,()=>n.remoteSyncer.rejectFailedWrite(s.batchId,r)),await Ul(n)}var i}(t,e),I1(t)&&T1(t)}async function Am(t,e){const n=V(t);n.asyncQueue.verifyOperationInProgress(),x("RemoteStore","RemoteStore received new credentials");const r=Er(n);n.mu.add(3),await lo(n),r&&n.pu.set("Unknown"),await n.remoteSyncer.handleCredentialChange(e),n.mu.delete(3),await bl(n)}async function fN(t,e){const n=V(t);e?(n.mu.delete(2),await bl(n)):e||(n.mu.add(2),await lo(n),n.pu.set("Unknown"))}function vi(t){return t.Tu||(t.Tu=function(e,n,r){const i=V(e);return i.ru(),new Z2(n,i.connection,i.authCredentials,i.appCheckCredentials,i.Tt,r)}(t.datastore,t.asyncQueue,{Xr:iN.bind(null,t),no:sN.bind(null,t),Ho:oN.bind(null,t)}),t.gu.push(async e=>{e?(t.Tu.Fo(),Yd(t)?Xd(t):t.pu.set("Unknown")):(await t.Tu.stop(),k1(t))})),t.Tu}function Ln(t){return t.Eu||(t.Eu=function(e,n,r){const i=V(e);return i.ru(),new eN(n,i.connection,i.authCredentials,i.appCheckCredentials,i.Tt,r)}(t.datastore,t.asyncQueue,{Xr:uN.bind(null,t),no:dN.bind(null,t),nu:cN.bind(null,t),eu:hN.bind(null,t)}),t.gu.push(async e=>{e?(t.Eu.Fo(),await Ul(t)):(await t.Eu.stop(),t._u.length>0&&(x("RemoteStore",`Stopping write stream with ${t._u.length} pending writes`),t._u=[]))})),t.Eu}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
