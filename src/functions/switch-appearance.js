export function makeDark() {
  ...
  // button expand
  root.style.setProperty('--bg-btn-expand', '#343333');
  root.style.setProperty('--fr-btn-expand', '#fff');
  // modal add new task
...
export function makeLight() {
  ...
  // button expand
  root.style.setProperty('--bg-btn-expand', '#f2f2f7');
  root.style.setProperty('--fr-btn-expand', '#181818');
  // modal add new task
  ...
  // task
  root.style.setProperty('--border-task', '#c9c9c9');
